...
<ul id="main-nav" class="nav nav-tabs nav-stacked " display="none">
    ...
    <li style="margin: 0" id="repairMenu"><a href="#repair" data-toggle="collapse">
        <i class="glyphicon glyphicon-cog"></i> 招聘维护
        <%--<span class="pull-right glyphicon glyphicon-chevron-down"></span>--%>
    </a>
        <ul id="repair" class="nav nav-list secondmenu"
            style="height: 0px;">
            ...
            <li><a href="javascript:copyClipBoard()"><i class="glyphicon glyphicon-globe"></i>我的拷贝</a></li>
        </ul>
    </li>
