var BootstrapPagination = function (n, t) {
    var i = function (n, t) {
        ...
        this.createPageInput = function () {
            var r = $("<li><\/li>"), u = $('<div class="input-group page-input"><\/div>'), t, n;
            r.append(u);
            t = "text";
            i() && (t = "number");
            n = $('<input type="' + t + '" class="form-control" />');
